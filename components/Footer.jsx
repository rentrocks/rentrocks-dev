...
const Footer = () => {
    return (
        <footer className='mb-20'>
            <div className="mx-auto grid max-w-screen-xl gap-y-8 gap-x-12 px-4 py-10 md:grid-cols-2 xl:grid-cols-4 xl:px-10 text-center">
                <div className="max-w-sm">
                    <div className="mb-6 flex h-12 items-center space-x-2 text-center justify-center">
                        <img src='/logo.png'/>
                    </div>
                ...
                <div className="">
                    ...
                    <div className="flex flex-col">
                        <div className="mb-4">
                            ...
                            <button className="block rounded-xl bg-blue-400  px-6 py-3 font-medium text-white mx-auto">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">2022 ZiShop. All rights reserved - Designed and Developed with by Abdullah.
